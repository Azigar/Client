 ...
 */
public class Progress_exp extends TextView {
    // Максимальное значение шкалы
    private int mMaxValue = 100;

    // Конструкторы
    public Progress_exp(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public Progress_exp(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Progress_exp(Context context) {
        super(context);
    }
    ...
    public synchronized void setValue(int value) {
        ...
        this.setText("опыт " + String.valueOf(value));
