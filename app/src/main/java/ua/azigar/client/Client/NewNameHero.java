...
/**
 * Created by Azigar on 02.08.2015.
 */
public class NewNameHero extends Thread {
    ...
    public NewNameHero(Handler h1, SocketConfig con) {  //главный
        this.h = h1;
        this.conf = con;
            ...
            try {
                ...
                if (cmd.equalsIgnoreCase(null)) { //если нет сообщения от сервера
                    ...
                    if (cmd.equalsIgnoreCase("YES_HERO")) {
                        conf.setSOCKET_MESSAGE("NEW_NAME_HERO");
                    }
                    ...
                    if (cmd.equalsIgnoreCase("NEW_NAME_HERO")) {
