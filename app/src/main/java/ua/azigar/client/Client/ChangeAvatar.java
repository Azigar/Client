 ...
 * клиент для изменение аватара сущесвующего героя
 */
public class ChangeAvatar extends Thread {
            ...
            try {
                ...
                if (cmd.equalsIgnoreCase(null)) { //если нет сообщения от сервера
                    ...
                    if (cmd.equalsIgnoreCase("YES_HERO")) {
                        conf.setSOCKET_MESSAGE("CHANGE_AVATAR");
                    }
                    //сервер спрашивает имя файла нового аватара
                    if (cmd.equalsIgnoreCase("NEW_AVATAR")) {
                        conf.setSOCKET_MESSAGE(conf.getAVATAR());
                    }
                    //теперь клиент будет задавать вопросы
                    if (cmd.equalsIgnoreCase("OK")) {
                        conf.setSOCKET_MESSAGE("AVATAR"); //клиент спрашивает, кто первый напал
                    }
                    //сервер спрашивает, что хочет клиент
                    if (cmd.equalsIgnoreCase("NEW_AVATAR_OK")) {
